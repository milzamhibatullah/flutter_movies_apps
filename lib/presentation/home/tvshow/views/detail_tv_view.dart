    ...
    return WillPopScope(
        child: Scaffold(
            ...
            body:SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: comtext.title(
                                    text: 'IMDB ${controller.detailTv.value.voteAverage!.ceilToDouble()}', color: Colors.white),
                              ),
                              const SizedBox(
                                width: 10.0,
                              ),
                              ...
                              comtext.title(text: controller.detailTv.value.voteAverage.toString().substring(0,3), color: Colors.red),
                              const SizedBox(
                                width: 6.0,
                              ),
                              comtext.regular(
                                  text: '(${NumberFormat.compact().format(controller.detailTv.value.voteCount)}) reviews',
                                  size: 14.0,
                                  color: Colors.white)
                            ],
                          ),
                          ...
                          ///title section
                          comtext.title(
                              text: controller.detailTv.value.name, color: Colors.white, size: 24.0),
                          const SizedBox(
                            height: 10.0,
                          ),
                          ...
                          ///genre section
                          controller.detailTv.value.genres!=null && controller.detailTv.value.genres!.isNotEmpty?Wrap(
                            crossAxisAlignment: WrapCrossAlignment.start,
                            children: controller.detailTv.value.genres
                            !.map(
                                  (e) => Container(
                                padding: const EdgeInsets.symmetric(
                                    vertical: 6.0, horizontal: 16.0),
                          ...
                          comtext.regular(
                              text: DateFormat('MMMM, dd yyyy').format(DateTime.parse(controller.detailTv.value.firstAirDate!)).toString(),
                              color: Colors.white,
                              size: 16.0),
                          const SizedBox(
                            height: 30.0,
              ...
              ), onRefresh: ()async=>controller.getDetailTv()):detailMovieShimmer()),
            )
        ),
        onWillPop: () async {
          print('popped');
