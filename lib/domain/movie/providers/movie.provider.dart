...
class MovieProvider extends GetConnect {
  ...
  Future<Response<TopRatedModel>> getTopRated() => get<TopRatedModel>(
        '${ConfigEnvironments.getEnvironments()['url']}movie/top_rated?api_key=$apiKey',
  ...
  Future<Response<MovieUpcomingModel>> getUpcomingMovie() =>
      get<MovieUpcomingModel>(
        '${ConfigEnvironments.getEnvironments()['url']}movie/upcoming?api_key=$apiKey',
        decoder: (obj) => MovieUpcomingModel.fromJson(obj),
      );

  ///fetch now playing movie
  Future<Response<NowPlayingModel>> getNowPlaying() => get<NowPlayingModel>(
        '${ConfigEnvironments.getEnvironments()['url']}movie/now_playing?api_key=$apiKey',
  ...
  Future<Response<PopularMovieModel>> getPopularMovie() =>
      get<PopularMovieModel>(
        '${ConfigEnvironments.getEnvironments()['url']}movie/popular?api_key=963a04d65af57e8e8269bda27d9c5482',
